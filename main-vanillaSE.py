...
from models import ConformerSE
...
class CausalSE(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--last_hidden_dim', type=int, default=768)
...
def cli_main():
    ...
    parser.add_argument('--data_dir', type=str, default='/path/to/data/dir')
